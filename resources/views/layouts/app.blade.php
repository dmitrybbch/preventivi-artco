...
<div id="app">
    <nav class="navbar navbar-expand-md navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav font-weight-bolder" style="font-family: Quicksand, sans-serif; font-size: 0.95rem; padding-left: 2rem">
                @auth
                    <li >
                        <a class="nav-link" href="{{ url('archive') }}"><i class="fas fa-archive"></i>&nbsp;&nbsp;ARCHIVIO </a>
                    </li>
