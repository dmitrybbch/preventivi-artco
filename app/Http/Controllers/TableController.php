     ...
     */
     ...
     public function orders($id)
     {
          ...
          foreach (Table::find($id)->orders() as $key => $order) {
            $food = $order->food();
            $json[] = array('id' => $order->food_id, 'nome' => $food->nome, 'prezzo' => $food->prezzo, 'total' => $order->total, 'descrizione' => $food->descrizione, 'categoria' => $food->categoria, 'immagine' => $food->immagine);
          }
